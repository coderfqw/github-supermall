...
export default {
  ...
  methods: {
    ...
    touchEnd: function (e) {
      ...
      if (this.distance === 0) {
        ...
        this.currentIndex--  // 向右移动超过0.5
      } else if (this.distance < 0 && currentMove > this.totalWidth * this.moveRatio) {
        this.currentIndex++  // 向左移动超过0.5
      }
  ...
  watch: {
    currentIndex(newName) {
      this.indicatorIndex = (newName + this.slideCount - 1)%this.slideCount
    }
  },
}
</script>
